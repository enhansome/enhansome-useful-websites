...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,708 | 🐛 106 | 📅 2026-09-02
...
* [Awesome MechEng](https://github.com/m2n037/awesome-mecheng#heat-transfer) ⭐ 1,696 | 🐛 22 | 📅 2024-09-24 - Awesome Mechanical Engineering Resources.
...
* [Open Source Society University - Computer Science](https://github.com/open-source-society/computer-science) ⭐ 209,150 | 🐛 28 | 🌐 HTML | 📅 2026-07-14 - Curriculum for computer science studies provided by the Open Source Society University.
...
* [MidJourney Styles and Keywords Reference](https://github.com/willwulfken/MidJourney-Styles-and-Keywords-Reference) ⭐ 12,297 | 🐛 1 | 📅 2025-04-11 - Styles and keywords for AI image generation.
...
* [Public APIs on GitHub](https://github.com/public-apis/public-apis) ⭐ 481,536 | 🐛 1,942 | 🌐 Python | 📅 2026-09-18 - Collective list of free APIs for use in software and web development
...
* [Arkenfox User.js](https://github.com/arkenfox/user.js/wiki/4.1-Extensions) ⭐ 12,854 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-09 - Privacy and security-related browser extensions.
* [Nothing Private](https://www.nothingprivate.ml/) - Check why you are not anonymous when using private browsing mode or incognito mode. You can also read it [here](https://github.com/gautamkrishnar/nothing-private) ⭐ 2,290 | 🐛 4 | 🌐 JavaScript | 📅 2025-12-09.
...
* [SmartTubeNext](https://github.com/yuliskov/SmartTubeNext) ⭐ 33,876 | 🐛 720 | 🌐 Java | 📅 2026-09-19 - Ad-free app for watching YouTube videos on Android TV boxes.
...
* [Awesome Fuzzing](https://github.com/secfigo/Awesome-Fuzzing) ⭐ 5,915 | 🐛 12 | 📅 2024-04-03 - A curated list of fuzzing resources, including tools, tutorials, research papers, and more.
...
* [EbookFoundation-Free-Programming-Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md) ⭐ 397,202 | 🐛 80 | 🌐 Python | 📅 2026-09-15 - Free and open source programming books
...
* [Google CTF on GitHub](https://github.com/google/google-ctf) ⭐ 5,026 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - Google's Capture The Flag competition resources available on GitHub.
...
* [Build Your Own X](https://github.com/codecrafters-io/build-your-own-x#build-your-own-neural-network) ⭐ 548,174 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14 - GitHub repository providing guides on building your favorite technologies from scratch.
* [Projects-Solutions on GitHub](https://github.com/karan/Projects-Solutions) ⭐ 4,387 | 🐛 229 | 📅 2024-07-10 - GitHub repository providing project-based coding challenges for learning programming through practical applications.
...
* You must add a link to this [GitHub main page](https://github.com/atakanaltok/awesome-useful-websites) ⭐ 1,274 | 🐛 104 | 📅 2026-05-28 in a relevant section visible to the user.
